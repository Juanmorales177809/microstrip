...
ANSWERS = ['robotica', 'inteligencia artificial', 'condicional', 'variables','iot','entrada','salida','actuadores','algoritmos','ciclos','cuerpo','sensores','conducta']
